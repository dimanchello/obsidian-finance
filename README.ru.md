...
**Версия:** 2.1.1 | **Минимальная версия Obsidian:** 1.8.7
...
Данные хранятся в `.obsidian/plugins/finance-manager/accounts/{accountId}/` в отдельных JSON-файлах:
...
.obsidian/plugins/finance-manager/accounts/{accountId}/
  ...
  exchanges.json  # валютные операции
  state.json      # настройки фильтров и видимости колонок
```
