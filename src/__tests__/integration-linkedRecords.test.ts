  ...
  describe('Deposit Operations', () => {
    it('удаление вклада удаляет все связанные записи', async () => {
      const deposit: DepositRecord = {
        ...
        accruals: [
          { id: 'acc-1', dueDate: '2026-02-01', amount: 416.67, status: PaymentStatus.PAID },
          { id: 'acc-2', dueDate: '2026-03-01', amount: 416.67, status: PaymentStatus.PAID },
        ],
        topUps: [],
        withdrawals: [],
        createdAt: Date.now(),
    ...
    it('удаление активного вклада создаёт возврат без linkedId', async () => {
      ...
      expect(finalData.records[0].type).toBe(RecordType.INCOME);
